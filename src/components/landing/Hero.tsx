    ...
    <section className="relative overflow-hidden bg-white py-16 md:py-24">
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex flex-col items-center text-center">
          <div className="inline-flex items-center rounded-full border border-emerald-100 bg-emerald-50 px-3 py-1 text-sm font-medium text-emerald-600 mb-6">
          ...
          <h1 className="max-w-4xl text-4xl font-extrabold tracking-tight text-slate-900 sm:text-5xl md:text-6xl">
            The Smart Way to Track Your <span className="text-emerald-500">Business Growth</span>
          </h1>
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            <Button size="lg" asChild className="bg-emerald-500 hover:bg-emerald-600 text-white px-8 h-auto min-h-[3.5rem] py-4 text-lg whitespace-normal text-center">
              <Link to="/signup">
                Get Started for as little as ₦2,000 monthly <ArrowRight className="ml-2 h-5 w-5 shrink-0" />
              </Link>
            </Button>
            <Button size="lg" variant="outline" asChild className="border-emerald-500 text-emerald-600 hover:bg-emerald-50 h-14 text-lg">
