...
const SalesDisplay = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg md:text-xl font-bold">Today's Sales Summary ({format(new Date(), 'PPP')})</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-baseline justify-between">
            <p className="text-base md:text-lg font-semibold">Total Sales:</p>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg md:text-xl font-bold">Sales History</CardTitle>
        </CardHeader>
        <CardContent>
                  ...
                  <TableRow>
                    <TableHead className="cursor-pointer text-xs md:text-sm" onClick={() => handleSort('date')}>
                      ...
                      {sortKey === 'date' && (
                        <ArrowUpDown
                          className={cn(
                            "ml-1 inline-block h-3 w-3 md:h-4 md:w-4",
